### This repo contains settings vs code settings for debugging c++11 ( can be edited to work on newer versions ) on MacOS. Just drop it into the .vscode project folder
